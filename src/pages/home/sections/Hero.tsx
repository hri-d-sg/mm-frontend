    ...
    >
      <SwiperSlide className=" relative after-content">
        <img
          ...
          src="https://images.pexels.com/photos/1201112/pexels-photo-1201112.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
          alt=""
        />
      </SwiperSlide>
      <SwiperSlide className=" relative after-content">
      ...
      <div className="absolute z-20  top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2  text-white">
        ...
        Rediscover the Magic of Music at Melo Mart
        </span>
        <p className=" mt-2 max-w-2xl mx-auto text-lg text-center hidden md:block">
          Melo Mart is a re commerce platform where you can sell and buy reused
